...
Lemma both_refused_by_app_spine : forall Γ,
  ~ Comp Γ (ECast fn g_ok) /\ ~ Comp Γ (ECast fn g_bad).
Proof. intros Γ. split; intros H; inversion H. Qed.
...
Proof.
  ...
  exact (eval_app_cast_opaque_stuck Φ Γ fn g_bad x v Hsat bad_splits H).
Qed.
