...
Proof.
  intros Γc e_con v_con Hevc Φ Γs σ S e_sym Hm Henv Hcont Hcon.
  exact (forall_form σ S Γc e_con v_con Hevc Φ Γs e_sym Hm Henv Hcont Hcon).
Qed.

Theorem concore_completeness_budget : target_completeness.
Proof.
  intros Φ Γs Γc σ S e_sym e_con v_con Hm Henv Hcont Hcon [hb Hb] Hevc.
  destruct (forall_form σ S Γc e_con v_con Hevc Φ Γs e_sym Hm Henv Hcont Hcon) as [h Hh].
